...
CreateMatrix& matrixBuild = matrixBuild.getInstance();
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
    case WM_COPYDATA:
        SetWindowPos(hWnd, NULL, 25, 25, 600, 600, NULL);
        matrixBuild.OnCopyData(hWnd, wParam, lParam); //функція рбробних даних з головного вікна 
        break;
    case WM_COMMAND:
        {
