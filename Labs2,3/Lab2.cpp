...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
        case WM_CREATE:
           toolbar.OnCreate(hWnd, hInst); //тут створимо Toolbar
           toolbar.PressBtn(hWnd, ID_TOOL_LINE);
           Alina.StartLineEditor(hWnd);
        case WM_SIZE:
            toolbar.OnSize(hWnd); //це повідомлення надсилається, якщо вікно змінить розмір
            break;
    ...
    case WM_COMMAND:
        {
            ...
            case ID_TOOL_DOT:
            case ID_DOT:
                Alina.StartPointEditor(hWnd); //початок вводу точкових об’єктів
                toolbar.PressBtn(hWnd, ID_TOOL_DOT);
                break;
            case ID_TOOL_LINE:
            case ID_LINE:
                Alina.StartLineEditor(hWnd); //початок вводу об’єктів-ліній
                toolbar.PressBtn(hWnd, ID_TOOL_LINE);
                break;
            case ID_TOOL_RECT:
            case ID_RECT:
                Alina.StartRectEditor(hWnd); //початок вводу прямокутників
                toolbar.PressBtn(hWnd, ID_TOOL_RECT);
                break;
            case ID_TOOL_ELLIPSE:
            case ID_ELLIPSE:
                Alina.StartEllipseEditor(hWnd); //початок вводу еліпсів
